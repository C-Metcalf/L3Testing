...
class GetConfig(QWidget):
    def __init__(self):
        ...
        self.pico.currentIndexChanged.connect(self.reset_stage)
    ...
    def update_ports(self, ports):
        ...
        self.pico.setCurrentIndex(index)
    ...
    def send_cycles(self):
        ...
        port = self.ser_port_dict.get(self.pico.currentText())
        port.write(data.encode())
        if self.pico.currentIndex() != 0:
            self.pico.setCurrentIndex(self.pico.currentIndex() - 1)
